...
# Determine the most important properties for ERK2_inhibition
feature_importances = rf_ERK2.feature_importances_
important_properties = properties_df.columns[feature_importances.argsort()[::-1]]
print("Most important properties for ERK2_inhibition:")
print(important_properties)